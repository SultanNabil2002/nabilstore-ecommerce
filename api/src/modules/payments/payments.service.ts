...
export class PaymentsService {
    ...
    async confirmPayment(
        ...
        if (paymentIntent.status !== 'succeeded') {
            throw new BadRequestException(`Payment for order ${orderId} is not successful`);
        }
    ...
    async findByOrder(orderId: string, userId: string): Promise<{
        ...
        return {
            ...
            message: payment ? 'Payment retrieved successfully' : 'No payment found for this order'
        };
    }
